...
echo " ::  Please stand-by... sox will 'play' $noise noise for $minutes minute(s) with binaural beats."
...
beats="play -q -c 2 -n -t pulseaudio synth 3540 sin 35 sin $freq2 \
vol -5db 
"
...
#  play --null synth $len browfreq2 = "35" + "528";nnoise band -n 1200 200 tremolo 20 .1 reverb 20
