...
CARRIER_FREQUENCY=6  # Base frequency for one channel (e.g., 150 Hz)
...
play -q -n synth \
     ...
     reverb 40 50 100 pitch -31.76665 vol 1.5 & 
play -q -n -c2 synth pinknoise mix band -n 9000 1800 tremolo 100 10 lowpass 1000 reverb 40 50 100 pitch -31.76665 vol 2.0 &
