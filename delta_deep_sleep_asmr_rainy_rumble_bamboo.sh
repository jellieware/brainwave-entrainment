...
function chime_sound() {
    ...
    play -q -n -c1 synth "$duration" sine "$freq" fade l 0 0.2 "$duration" gain -n "$gain" lowpass 30 vol 2.0 &
}
...
play -q -n -c2 synth pinknoise mix band -n 9000 1800 tremolo 2000 1 lowpass 1000 reverb 40 50 100 pitch -31.76665 vol 0.2 \
