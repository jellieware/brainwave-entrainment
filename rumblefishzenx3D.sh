...
play -q -n synth \
   ...
   play -q -n -c2 synth pinknoise mix band -n 9000 1000 tremolo 2000 1 lowpass 1000 reverb 40 50 100 pitch -31.76665 vol 0.5 &
...
FADE_IN_DURATION=2
FADE_OUT_DURATION=5
play -q -n -c2 synth 10 pinknoise mix band -n 9000 1000 tremolo 2000 1 lowpass 1000 reverb 40 50 100 pitch -31.76665 vol 0.8 remix 1 1 fade h "$FADE_IN_DURATION" "$((DURATION - FADE_OUT_DURATION))" "$FADE_OUT_DURATION"
...
FADE_IN_DURATION=2
FADE_OUT_DURATION=5
play -q -n -c2 synth 10 pinknoise mix band -n 9000 1000 tremolo 2000 1 lowpass 1000 reverb 40 50 100 pitch -31.76665 vol 0.8 remix 0 1 fade h "$FADE_IN_DURATION" "$((DURATION - FADE_OUT_DURATION))" "$FADE_OUT_DURATION"
#chorus $GAIN_IN $GAIN_OUT "$BASE_DELAY_MS" "$DECAY_MS" "$SPEED_HZ" "$DEPTH_MS" -t &
sleep $ZRAND_FLOAT
...
FADE_IN_DURATION=2
FADE_OUT_DURATION=5
play -q -n -c2 synth 10 pinknoise mix band -n 9000 1000 tremolo 2000 1 lowpass 1000 reverb 40 50 100 pitch -31.76665 vol 0.8 remix 1 0 fade h "$FADE_IN_DURATION" "$((DURATION - FADE_OUT_DURATION))" "$FADE_OUT_DURATION"
#chorus $GAIN_IN $GAIN_OUT "$BASE_DELAY_MS" "$DECAY_MS" "$SPEED_HZ" "$DEPTH_MS" -t &
sleep $ZRAND_FLOAT
